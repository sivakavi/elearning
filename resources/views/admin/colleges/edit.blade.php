...
@section('title', __('views.admin.college.edit.title'))

@section('content')
    <div class="page-header clearfix">
        {{-- <h1><i class="glyphicon glyphicon-edit"></i> Colleges / Edit #{{$college->id}}</h1> --}}
    </div>
    @include('error')
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content margin-top-40">
                                    <div class="form-group @if($errors->has('name')) has-error @endif">
                                        ...
                                        <input type="text" id="name-field" name="name" class="form-control" value="{{ is_null(old("name")) ? $college->name : old("name") }}"/>
                                        @if($errors->has("name"))
                                    ...
                                    <div class="form-group @if($errors->has('address')) has-error @endif">
                                        ...
                                        <textarea class="form-control" id="address-field" rows="3" name="address">{{ is_null(old("address")) ? $college->address : old("address") }}</textarea>
                                    ...
                                    <div class="form-group @if($errors->has('phno')) has-error @endif">
                                        ...
                                        <input type="text" id="phno-field" name="phno" class="form-control" value="{{ is_null(old("phno")) ? $college->phno : old("phno") }}"/>
                                        @if($errors->has("phno"))
                                    ...
                                    <div class="form-group @if($errors->has('contact_person')) has-error @endif">
                                        ...
                                        <input type="text" id="contact_person-field" name="contact_person" class="form-control" value="{{ is_null(old("contact_person")) ? $college->contact_person : old("contact_person") }}"/>
                                    ...
                                    <div class="form-group @if($errors->has('contact_person_phno')) has-error @endif">
                                        ...
                                        <input type="text" id="contact_person_phno-field" name="contact_person_phno" class="form-control" value="{{ is_null(old("contact_person_phno")) ? $college->contact_person_phno : old("contact_person_phno") }}"/>
                                    ...
                                    <div class="form-group @if($errors->has('website')) has-error @endif">
                                        ...
                                        <input type="text" id="website-field" name="website" class="form-control" value="{{ is_null(old("website")) ? $college->website : old("website") }}"/>
